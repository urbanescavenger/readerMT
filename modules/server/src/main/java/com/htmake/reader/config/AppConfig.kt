...
class AppConfig {
    ...
    var sharedBookSource = false    // 是否共享书源(secure 模式下生效,书源全局共用、书架仍按用户隔离)
    ...
    var remoteWebviewApi = ""    // 无头浏览器服务地址(如 http://browserless:3000),用于 startBrowserAwait 过 Cloudflare 等人机验证
    var remoteWebviewToken = ""  // 无头浏览器服务 token(可选)
