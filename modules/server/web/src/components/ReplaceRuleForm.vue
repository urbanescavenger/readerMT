    ...
    <el-form :model="ruleForm">
      ...
      <el-form-item label="替换范围">
        <el-input
          ...
          placeholder="留空表示作用于全部书籍"
        ></el-input>
      </el-form-item>
      <el-form-item label="排除范围">
        <el-input v-model="ruleForm.excludeScope"></el-input>
      </el-form-item>
      <el-checkbox v-model="ruleForm.isRegex">使用正则表达式</el-checkbox>
      <el-checkbox v-model="ruleForm.isEnabled">是否启用</el-checkbox>
      <el-checkbox v-model="ruleForm.scopeTitle">作用于章节标题</el-checkbox>
    </el-form>
