...
/**
 * 引擎版 OkHttpUtils(从 readerMT `help/http/OkHttpUtils.kt` 移植,纯 JVM,无 Android 依赖)。
 * 提供 Request.Builder 扩展(addHeaders/get/postForm/postMultipart/postJson)、
 * OkHttpClient 挂起扩展(newCallResponse/newCallResponseBody/newCallStrResponse)、
 * Call.await、ResponseBody.text(编码判定)/decompressed。AnalyzeUrl 的 HTTP 簇消费。
 */
